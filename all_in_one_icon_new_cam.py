...
no_gesture_timeout = 1  # 2 seconds timeout
...
drag_and_drop_off = cv2.imread("icons/drag_and_drop/3.png")
peace_sign_off = cv2.imread("icons/peace_sign/3.png")
gesture_3_off = cv2.imread("icons/gesture_3/3.png")
gesture_4_off = cv2.imread("icons/gesture_4/3.png")
palm_off = cv2.imread("icons/palm/3.png")
long_click_off = cv2.imread("icons/long_click/3.png")
short_click_off = cv2.imread("icons/short_click/3.png")
thumbs_up_off = cv2.imread("icons/thumbs_up/3.png")
zoom_in_off = cv2.imread("icons/zoom_in/3.png")
zoom_out_off = cv2.imread("icons/zoom_out/3.png")
no_gesture_off = cv2.imread("icons/no_gesture/3.png")

drag_and_drop = cv2.imread("icons/drag_and_drop/1.png")
peace_sign = cv2.imread("icons/peace_sign/1.png")
gesture_3 = cv2.imread("icons/gesture_3/1.png")
gesture_4 = cv2.imread("icons/gesture_4/1.png")
palm = cv2.imread("icons/palm/1.png")
long_click = cv2.imread("icons/long_click/1.png")
short_click = cv2.imread("icons/short_click/1.png")
thumbs_up = cv2.imread("icons/thumbs_up/1.png")
zoom_in = cv2.imread("icons/zoom_in/1.png")
zoom_out = cv2.imread("icons/zoom_out/1.png")
no_gesture = cv2.imread("icons/no_gesture/1.png")
...
while True:
    ...
    if hands:
        ...
        if fingers == [1,1,0,0,0]:          # zoom
            ...
            # if fingers == [0,1,1,0,0] and previously_down_two:
            #     # cv2.putText(img, "Two finger click", (600, 50), cv2.FONT_HERSHEY_PLAIN, 2, (255, 0, 0), 3)
            #     text = "Two finger click"
            #     gesture = thumbs_up
            #     p = 5
    ...
    if save_video: result.write(img)
